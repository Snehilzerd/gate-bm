...
\hline
	...
	All positive &C_{5,0}(0.1)^{5} &0.00001\\ \hline
	4 positive 1 negative &C_{5,1}(0.1)^{4}(0.9) &0.00045  \\ 
	\hline
	3 positive 2 negative &C_{5,2}(0.1)^{3}(0.9)^{2} &0.00810 \\ 
	\hline
	2 positive 3 negative &C_{5,3}(0.1)^{2}(0.9)^{3} &0.07290\\ \hline
	1 positive 4 negative &C_{5,4}(0.1)^{1}(0.9)^{4} &0.32805 \\ \hline
	5 negaive &C_{5,5}(0.9)^{5} &0.5904 \\ \hline
\end{tabular}
\end{table}
\begin{align}
